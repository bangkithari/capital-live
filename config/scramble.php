...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'CpitalLive Insurance CRM API. Login with POST /v1/auth/login, copy the access_token, then set it in BearerAuth before trying protected endpoints.',
    ],

    'ui' => [
        'title' => 'CpitalLive API Documentation',
    ],
    ...
    'security_strategy' => [
        ...
        [
            ...
            'scheme' => \Dedoc\Scramble\Support\Generator\SecurityScheme::http('bearer', 'JWT')
                ->as('BearerAuth')
                ->setDescription('Use the access_token from POST /v1/auth/login as a Bearer token.'),
        ],
    ],
];
